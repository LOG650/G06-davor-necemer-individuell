...
| 3.2 | Datainnsamling og vask av bedriftsdata | 2026-03-26 | In progress, delayed | Qlik-volum, kampanjer og lansering/sanering er lastet lokalt og forste vask er gjennomfort. Sensitive data ignoreres av Git inntil anonymisering er klar. |
...
1. **Datainnsamling:** Ukentlig volumgrunnlag er lastet og vasket lokalt, men data maa anonymiseres for de kan pushes eller brukes som del av leveranse.
