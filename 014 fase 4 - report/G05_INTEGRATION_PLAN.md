...
**Frist sluttrapport:** 2026-06-01 kl. 14:00 (utvidet fra 31.05; muntlig 2026-06-05)
...
| Lovet sensitivitetsanalyse fra §1.4 og §5.1.2 er i praksis bare indeks-kjøring med 0.00 utfall — metode og resultat matcher ikke | Sluttrapport §5.1.2 + §8.4 | Reformuler metodebeskrivelsen til å matche faktisk gjennomført arbeid; flytt full sensitivitetsanalyse til "Gjenstår" | 25 min | Done (§5.1.2 skiller metodisk ramme vs. faktisk kjørt; full sensitivitet rutet til §8.5/§9.4/§10; §1.4 Antagelse 3 justert; sluttreview 31.05: residual present-tense-overclaim i §3.2/§3.3/§5.3 også dempet til «tenkt»/smoke-test — funnet nå reelt lukket) |
